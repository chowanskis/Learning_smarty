...
{include file="navigation.tpl" page_title="Proœba o ofertê us³ug doradczych"}

<form method="post" action="request_quote.php">
<table border="1">
  <tr>
    <td bgcolor="{cycle values="#F0F0F0,#DDDDDD"}">Nazwisko:</td>
    <td><input type="text" name="full_name" size="40"></td>
  </tr>
  <tr>
    <td bgcolor="{cycle values="#F0F0F0,#DDDDDD"}">Numer telefonu:</td>
